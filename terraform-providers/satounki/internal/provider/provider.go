...
func (p *provider) GetResources(ctx context.Context) (map[string]tfsdk.ResourceType, diag.Diagnostics) {
	return map[string]tfsdk.ResourceType{
		"satounki_aws_account":        awsAccountResourceType{},
		"satounki_cloudflare_account": cloudflareAccountResourceType{},
		"satounki_gcp_project":        gcpProjectResourceType{},
		"satounki_user_aliases":       userAliasesResourceType{},
		"satounki_user_roles":         userRolesResourceType{},
		"satounki_policy":             policyResourceType{},
	}, nil
}
